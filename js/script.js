const MAXIMOS_INTENTOS = 5, // Intentos máximos que tiene el jugador
  ...
  NOMBRE_IMAGEN_OCULTA = "./img/question.svg"; // La imagen que se muestra cuando la real está oculta
new Vue({
  el: "#app",
  data: () => ({
  ...
  methods: {
    mostrarCreditos() {
      Swal.fire({
        title: "Acerca de",
        html: `
                Icons by flaticon Wholsale and mask 
                `,
    ...
    indicarFracaso() {
      Swal.fire({
        title: "Perdiste",
        html: `
                <img class="img-fluid" src="./img/perdiste.svg" alt="Perdiste">
    ...
    indicarVictoria() {
      Swal.fire({
        title: "¡Enhorabuena!",
        html: `
                <img class="img-fluid" src="./img/Ganaste.svg" alt="Enhorabuena">
